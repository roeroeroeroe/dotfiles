...
var Components = []statusbar.Component{
	...
	c.NewText(" vol:"),
	c.NewExec([]string{"volume"}, 0, 3*time.Second, 36),
	c.NewText(" ]   [ "),
	c.NewIP(iface),
	c.NewText(" "),
	c.NewNet(iface, time.Second, 0),
	c.NewText(" tcp{"),
	c.NewTCP(time.Second, 0),
	c.NewText("} ]   [ disk{u:"),
	c.NewDisk("/", c.DiskUsed, 3*time.Second, 0),
	c.NewText(" io:"),
	c.NewDiskIO(blockDevice, time.Second, 0),
	c.NewText("} mem:"),
	c.NewMem(c.MemUsed, 2*time.Second, 0),
	c.NewText(" swap:"),
	c.NewSwap(c.SwapUsed, 2*time.Second, 0),
	c.NewText(" cpu:"),
